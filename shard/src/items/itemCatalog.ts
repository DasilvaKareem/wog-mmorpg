...
export const ITEM_CATALOG: ItemDefinition[] = [
  ...
  // --- Elite Craftable Weapons (only obtainable through crafting) ---
  {
    tokenId: 180n,
    name: "Voidsteel Greatsword",
    description: "A massive blade forged from Promic-infused steel. Hums with self-repairing energy. +28 STR, +5 AGI.",
    copperPrice: 700,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 181n,
    name: "Promic Warstaff",
    description: "A crystalline staff that channels regenerative magic. +24 INT, +10 FAITH.",
    copperPrice: 650,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 182n,
    name: "Caesaric Longbow",
    description: "A bow strung with Caesaric crystal wire. Projects holographic arrows. +20 AGI, +10 STR.",
    copperPrice: 600,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 183n,
    name: "Neodynic Battleaxe",
    description: "A magnetically charged axe that pulls toward its target. +32 STR, -3 DEF.",
    copperPrice: 800,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 184n,
    name: "Lantharum Dagger",
    description: "A blade etched with glowing Lantharum runes that activate on contact. +26 AGI, +6 STR.",
    copperPrice: 550,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 185n,
    name: "Telluron Platemail",
    description: "Armor woven with Telluron fiber that conducts defensive magic through the wearer. +18 DEF, +6 STR.",
    copperPrice: 600,
    category: "armor",
    equipSlot: "chest",
    armorSlot: "chest",
    statBonuses: { def: 18, str: 6 },
    maxDurability: 160,
  },
  {
    tokenId: 186n,
    name: "Prasic Warhelm",
    description: "A helm of flexible Prasic glass that grants enhanced battlefield awareness. +12 DEF, +4 INT.",
    copperPrice: 450,
    category: "armor",
    equipSlot: "helm",
    armorSlot: "helm",
    statBonuses: { def: 12, int: 4 },
    maxDurability: 130,
  },
  {
    tokenId: 187n,
    name: "Samaronic Greaves",
    description: "Iridescent greaves that shimmer and shift, confusing attackers. +14 DEF, +5 AGI.",
    copperPrice: 500,
    category: "armor",
    equipSlot: "legs",
    armorSlot: "legs",
    statBonuses: { def: 14, agi: 5 },
    maxDurability: 140,
  },
  {
    tokenId: 188n,
    name: "Barylian Warboots",
    description: "Heat-resistant boots sealed with Barylian wax. +10 DEF, +8 AGI.",
    copperPrice: 400,
    category: "armor",
    equipSlot: "boots",
    armorSlot: "boots",
    statBonuses: { def: 10, agi: 8 },
    maxDurability: 120,
  },
  {
    tokenId: 189n,
    name: "Ceric Pauldrons",
    description: "Temperature-regulating shoulder plates forged with Ceric foam cores. +16 DEF, +4 STR.",
    copperPrice: 550,
    category: "armor",
    equipSlot: "shoulders",
    armorSlot: "shoulders",
    statBonuses: { def: 16, str: 4 },
    maxDurability: 145,
  },

  // --- Building Materials (190-199) ---
  {
    tokenId: 190n,
    name: "Lumber",
    description: "Sturdy planks cut from hardwood trees. The backbone of any structure.",
    copperPrice: 15,
    category: "material",
  },
  {
    tokenId: 191n,
    name: "Stone Blocks",
    description: "Quarried stone blocks, smooth and heavy. Essential for foundations.",
    copperPrice: 20,
    category: "material",
  },
  {
    tokenId: 192n,
    name: "Iron Nails",
    description: "Forged iron nails for securing wooden joints. Sold in bundles of 50.",
    copperPrice: 10,
    category: "material",
  },
  {
    tokenId: 193n,
    name: "Thatch Bundle",
    description: "Dried reed bundles for roofing. Waterproof when layered properly.",
    copperPrice: 8,
    category: "material",
  },
  {
    tokenId: 194n,
    name: "Clay Bricks",
    description: "Kiln-fired bricks for sturdy walls and chimneys.",
    copperPrice: 18,
    category: "material",
  },
  {
    tokenId: 195n,
    name: "Glass Panes",
    description: "Clear glass panes for windows. Fragile but lets in light.",
    copperPrice: 25,
    category: "material",
  },
  {
    tokenId: 196n,
    name: "Timber Frame",
    description: "Pre-cut A-frame timbers for structural support.",
    copperPrice: 30,
    category: "material",
  },
  {
    tokenId: 197n,
    name: "Mortar",
    description: "Cement-like paste for bonding stone and brick together.",
    copperPrice: 12,
    category: "material",
  },
  {
    tokenId: 198n,
    name: "Roof Tiles",
    description: "Terracotta tiles for weatherproof roofing.",
    copperPrice: 22,
    category: "material",
  },
  {
    ...
    description: "A heavy claw hammer used for construction work.",
    copperPrice: 35,
    category: "tool",
  },
  ...
  // --- Crops (200-219) ---
  {
    tokenId: 200n,
    name: "Wheat",
    description: "Golden stalks of wheat. Staple crop for bread and ale.",
    copperPrice: 5,
    category: "material",
  },
  {
    tokenId: 201n,
    name: "Corn",
    description: "Plump ears of corn. Versatile cooking ingredient.",
    copperPrice: 5,
    category: "material",
  },
  {
    tokenId: 202n,
    name: "Carrots",
    description: "Crunchy orange root vegetables. Good for stews.",
    copperPrice: 8,
    category: "material",
  },
  {
    tokenId: 203n,
    name: "Potatoes",
    description: "Hearty tubers that grow in most soils. A farmer's friend.",
    copperPrice: 8,
    category: "material",
  },
  {
    tokenId: 204n,
    name: "Pumpkins",
    description: "Large orange gourds. Used in pies and potions.",
    copperPrice: 15,
    category: "material",
  },
  {
    tokenId: 205n,
    name: "Rice",
    description: "Paddy-grown grain. Requires wet soil to cultivate.",
    copperPrice: 12,
    category: "material",
  },
  {
    tokenId: 206n,
    name: "Watercress",
    description: "Aquatic herb that thrives in flowing water. Peppery flavor.",
    copperPrice: 18,
    category: "material",
  },
  {
    tokenId: 207n,
    name: "Mushrooms",
    description: "Wild-growing fungi from dark, damp places. Alchemical ingredient.",
    copperPrice: 10,
    category: "material",
  },
  {
    tokenId: 208n,
    name: "Berries",
    description: "Plump mixed berries — sweet and tart. Used in cooking and alchemy.",
    copperPrice: 6,
    category: "material",
  },
  {
    tokenId: 209n,
    name: "Barley",
    description: "Hardy cereal grain used in brewing and baking.",
    copperPrice: 14,
    category: "material",
  },
  {
    tokenId: 210n,
    name: "Hops",
    description: "Climbing vine cones used to flavor ales and tonics.",
    copperPrice: 16,
    category: "material",
  },
  {
    tokenId: 211n,
    name: "Apples",
    description: "Crisp orchard fruit. Eaten fresh or pressed into cider.",
    copperPrice: 18,
    category: "material",
  },
  {
    tokenId: 212n,
    name: "Grapes",
    description: "Vine-ripened clusters used for wine and enchanted preserves.",
    copperPrice: 25,
    category: "material",
  },
  {
    tokenId: 213n,
    name: "Moonberries",
    description: "Luminescent berries that glow under moonlight. Rare alchemical reagent.",
    copperPrice: 40,
    category: "material",
  },
  {
    tokenId: 214n,
    name: "Glowroot",
    description: "Bioluminescent root that pulses with faint magical energy.",
    copperPrice: 50,
    category: "material",
  },
  {
    tokenId: 215n,
    name: "Turnips",
    description: "Hardy root vegetables. Quick-growing and nutritious.",
    copperPrice: 5,
    category: "material",
  },
  {
    tokenId: 216n,
    name: "Ironwort",
    description: "A metallic-tasting herb that strengthens potions and armor lacquer.",
    copperPrice: 60,
    category: "material",
  },
  {
    tokenId: 217n,
    name: "Crystalmelon",
    description: "A melon with crystalline rind that refracts light. Extremely rare.",
    copperPrice: 120,
    category: "material",
  },
  {
    tokenId: 218n,
    name: "Starfruit",
    description: "A star-shaped fruit infused with celestial essence. Prized by enchanters.",
    copperPrice: 150,
    category: "material",
  },
  {
    ...
    description: "Nutritious seeds from giant sunflowers. Used in cooking and as animal feed.",
    copperPrice: 4,
    category: "material",
  },

  // --- Farming Tools (220-223) ---
  {
    tokenId: 220n,
    name: "Wooden Hoe",
    description: "A basic wooden hoe for tilling soil and harvesting crops. Tier 1.",
    copperPrice: 15,
    category: "tool",
    equipSlot: "weapon",
    statBonuses: { str: 1 },
  ...
  },
  {
    tokenId: 221n,
    name: "Iron Hoe",
    description: "A sturdy iron hoe for intermediate farming. Tier 2.",
    copperPrice: 50,
    category: "tool",
    equipSlot: "weapon",
    statBonuses: { str: 2 },
  ...
  },
  {
    tokenId: 222n,
    name: "Steel Hoe",
    description: "A precision steel hoe for advanced crops. Yields bonus harvests. Tier 3.",
    copperPrice: 150,
    category: "tool",
    equipSlot: "weapon",
    statBonuses: { str: 3 },
  ...
  },
  {
    tokenId: 223n,
    name: "Enchanted Hoe",
    description: "A magically enhanced hoe that can harvest the rarest crops. Tier 4.",
    copperPrice: 400,
    category: "tool",
    equipSlot: "weapon",
  ...
  // --- Unique Craftable Weapons (231-242) ---
  // Tier 1 — Ore-forged (comparable to Iron Sword / Hunter's Bow)
  {
    tokenId: 231n,
    name: "Frostfang Dagger",
    description: "A jagged blade quenched in moonflower extract. Leaves frostbite on contact. +7 AGI, +3 STR.",
    copperPrice: 130,
    category: "weapon",
    equipSlot: "weapon",
  ...
  },
  {
    tokenId: 232n,
    name: "Emberclaw Mace",
    description: "A coal-fired mace with smoldering copper teeth. Burns hot even after the forge cools. +6 STR, +5 HP.",
    copperPrice: 140,
    category: "weapon",
    equipSlot: "weapon",
  ...
  },
  {
    tokenId: 233n,
    name: "Thornvine Whip",
    description: "A living weapon — lavender-infused copper wire that regrows its thorns overnight. +5 AGI, +5 STR.",
    copperPrice: 120,
    category: "weapon",
    equipSlot: "weapon",
  ...
  },
  {
    tokenId: 234n,
    name: "Gloomveil Wand",
    description: "Silver core wrapped in dried sage. Casts a faint shadow even in bright light. +9 INT.",
    copperPrice: 110,
    category: "weapon",
    equipSlot: "weapon",
    statBonuses: { int: 9 },
  ...
  {
    tokenId: 235n,
    name: "Wraithbone Scimitar",
    description: "Curved blade alloyed with moonflower pollen — the edge shimmers like a mirage. +10 STR, +6 AGI.",
    copperPrice: 260,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 236n,
    name: "Duskhollow Warhammer",
    description: "A steel-alloy head so dense it warps the air on each swing. Crushes armor like parchment. +17 STR.",
    copperPrice: 340,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 237n,
    name: "Serpentcoil Longbow",
    description: "Dragon's Breath resin coats the limbs — arrows ignite mid-flight. +10 AGI, +5 STR.",
    copperPrice: 280,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 238n,
    name: "Starweaver Scepter",
    description: "Gold-and-silver focus crowned with a starbloom that never wilts. Channels starlight. +14 INT, +4 FAITH.",
    copperPrice: 320,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 239n,
    name: "Bloodthorn Claymore",
    description: "A massive two-hander with Dragon's Breath thorns fused into the fuller. Draws blood on parry. +22 STR, -2 AGI.",
    copperPrice: 500,
    category: "weapon",
    equipSlot: "weapon",
  ...
  },
  {
    ...
    description: "Triple-refined silver blade so thin it whistles through armor gaps. Duelist's dream. +8 STR, +14 AGI.",
    copperPrice: 460,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 241n,
    name: "Stormcaller Arbalest",
    description: "Steel-alloy crossbow with Cryptonic Crystal lenses that guide bolts through wind. +12 AGI, +8 STR.",
    copperPrice: 490,
    category: "weapon",
    equipSlot: "weapon",
  ...
  {
    tokenId: 242n,
    name: "Oathkeeper Maul",
    description: "A Scandix Steel warmaul consecrated in gold. Swings true against oathbreakers. +16 STR, +8 FAITH.",
    copperPrice: 530,
    category: "weapon",
    equipSlot: "weapon",
