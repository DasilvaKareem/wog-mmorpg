...
import { registerDungeonTools } from "./tools/dungeon.js";
import { registerEnchantingTools } from "./tools/enchanting.js";
...
export function createMcpServer(): McpServer {
  ...
  registerDungeonTools(server);
  registerEnchantingTools(server);
