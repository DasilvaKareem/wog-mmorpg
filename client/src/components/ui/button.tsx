...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 border-4 border-black px-3 py-2 text-[12px] uppercase tracking-wide text-black shadow-[4px_4px_0_0_#000] transition disabled:pointer-events-none disabled:opacity-60 disabled:shadow-none",
  {
    variants: {
      variant: {
