...
const SLOTS: Record<string, TunableSlot> = {
  ...
  staff:           { label: "Staff",          pos: { x: 0.03, y: 0.16, z: 0.07 },  rot: { x: 0.308, y: 0, z: 0.05 } },
  bow:             { label: "Bow",            pos: { x: 0.10, y: 0.02, z: -0.11 }, rot: { x: 0.408, y: 1.458, z: 0 } },
  dagger:          { label: "Dagger",         pos: { x: 0, y: 0.02, z: 0.07 },     rot: { x: 1.308, y: 0, z: -0.1 } },
  mace:            { label: "Mace",           pos: { x: 0.05, y: 0.09, z: 0.19 },  rot: { x: 1.058, y: 0.558, z: -0.1 } },
  pickaxe:         { label: "Pickaxe",        pos: { x: 0.04, y: 0.07, z: 0.23 },  rot: { x: 1.158, y: 0, z: -0.1 } },
  shield:          { label: "Shield",         pos: { x: -0.09, y: 0.05, z: 0.03 }, rot: { x: 0.558, y: 0.108, z: 0 } },
