...
const TOWN_ASSET_DEFS: Record<string, { file: string; scale: number; yOffset: number }> = {
  ...
  // Roofs — standard
  town_roof_corner_inner: { file: "roof-corner-inner.glb", scale: 3.0, yOffset: 0 },
  town_roof_corner_round: { file: "roof-corner-round.glb", scale: 3.0, yOffset: 0 },
  town_roof_corner: { file: "roof-corner.glb", scale: 3.0, yOffset: 0 },
  town_roof_flat: { file: "roof-flat.glb", scale: 3.0, yOffset: 0 },
  town_roof_gable_detail: { file: "roof-gable-detail.glb", scale: 3.0, yOffset: 0 },
  town_roof_gable_end: { file: "roof-gable-end.glb", scale: 3.0, yOffset: 0 },
  town_roof_gable_top: { file: "roof-gable-top.glb", scale: 3.0, yOffset: 0 },
  town_roof_gable: { file: "roof-gable.glb", scale: 3.0, yOffset: 0 },
  town_roof_left: { file: "roof-left.glb", scale: 3.0, yOffset: 0 },
  town_roof_point: { file: "roof-point.glb", scale: 3.0, yOffset: 0 },
  town_roof_right: { file: "roof-right.glb", scale: 3.0, yOffset: 0 },
  town_roof_window: { file: "roof-window.glb", scale: 3.0, yOffset: 0 },
  town_roof: { file: "roof.glb", scale: 3.0, yOffset: 0 },
  // Roofs — high
  town_roof_high_corner_round: { file: "roof-high-corner-round.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_corner: { file: "roof-high-corner.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_cornerinner: { file: "roof-high-cornerinner.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_flat: { file: "roof-high-flat.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_gable_detail: { file: "roof-high-gable-detail.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_gable_end: { file: "roof-high-gable-end.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_gable_top: { file: "roof-high-gable-top.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_gable: { file: "roof-high-gable.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_left: { file: "roof-high-left.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_point: { file: "roof-high-point.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_right: { file: "roof-high-right.glb", scale: 3.0, yOffset: 0 },
  town_roof_high_window: { file: "roof-high-window.glb", scale: 3.0, yOffset: 0 },
  town_roof_high: { file: "roof-high.glb", scale: 3.0, yOffset: 0 },
  // Stairs
